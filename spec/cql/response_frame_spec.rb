...
module Cql
  describe ResponseFrame do
    ...
    context 'when fed more bytes than needed' do
      ...
      it 'adasdad' do
        described_class.new("\x81\x00\a\b\x00\x00\x00_\x00\x00\x00\x02\x00\x00\x00\x01\x00\x00\x00\x03\x00\ncql_rb_349\x00\x05users\x00\tuser_name\x00\r\x00\x05email\x00\r\x00\bpassword\x00\r\x00\x00\x00\x01\x00\x00\x00\x03sam\x00\x00\x00\vsam@ham.com\xFF\xFF\xFF\xFF\x81\x00)\b\x00\x00\x00_\x00\x00\x00\x02\x00\x00\x00\x01\x00\x00\x00\x03\x00\ncql_rb_349\x00\x05users\x00\tuser_name\x00\r\x00\x05email\x00\r\x00\bpassword\x00\r\x00\x00\x00\x01\x00\x00\x00\x03sam\x00\x00\x00\vsam@ham.com\xFF\xFF\xFF\xFF")
      end
    end
  end
end