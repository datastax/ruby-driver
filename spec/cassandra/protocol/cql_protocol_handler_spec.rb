      ...
      describe '#send_request' do
        ...
        context 'when a compressor is specified' do
          ...
          it 'decompresses response frames' do
            ...
            f1.value.should == Protocol::PreparedResultResponse.new(id, [["cql_rb_911", "users", "user_name", Types.varchar]], nil, nil, nil)
            f2.value.should == Protocol::PreparedResultResponse.new(id, [["cql_rb_911", "users", "user_name", Types.varchar]], nil, nil, nil)
          end
        end
